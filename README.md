...
- **Успешный challenge/believe**: +2.0 (когда агент успешно поймал блеф оппонента)
- **Неудачный challenge/believe**: -2.0 (когда агент вызвал и ошибся, что привело к потере кости)
...
- **Защита ставки от believe**: +5.0 (когда оппонент вызвал believe на ставку агента и ошибся)
