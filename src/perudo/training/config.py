...
class TrainingConfig:
    ...
    entropy_threshold_low: float = -0.4
    entropy_threshold_high: float = -0.2
    entropy_adjustment_rate: float = 0.01
    entropy_max_coef: float = 0.05
