"""
Bot personality constants for Perudo game bots.
"""
...
class BotAffinities:
    ...
    first_bid_analysis: float
    pre_reveal_analysis: float
    face_pattern_analysis: float
